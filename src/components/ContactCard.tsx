        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1.5 max-w-3xl">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-[#FCC200] bg-white/10 px-2.5 py-0.5 rounded-full">
                Onderwijs & Kwaliteit
              </span>
            </div>
          ...
          <div className="shrink-0">
            <a
              href="mailto:TG-SO-adviseurs@hr.nl?subject=Vraag%20over%20stagediscriminatie%20/%20professionalisering%20op%20maat%20(Onderwijs%20%26%20Kwaliteit)"
