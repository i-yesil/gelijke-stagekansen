...
export const Intro: React.FC = () => {
  ...
  return (
    <div className="mb-8 grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-5 items-stretch">
      {/* Linker vakje: Inleiding & Achtergrond (eigen beige container) */}
      <div className="lg:col-span-7 xl:col-span-8 bg-[#F7EFE3] p-6 md:p-7 rounded-2xl border border-[#EDE6DA] text-[#003340] shadow-none flex flex-col justify-between">
        <div className="space-y-3.5">
          ...
          {expanded && (
            <div className="pt-3.5 mt-3.5 border-t border-[#E8E4DA] text-sm md:text-base text-[#003340] space-y-3 leading-relaxed animate-in fade-in">
              <p>
        ...
        <button
          ...
          className="mt-4 text-xs md:text-sm font-semibold text-[#D3104C] hover:text-[#B41E4B] inline-flex items-center gap-1 cursor-pointer transition-colors self-start"
        >
          {expanded ? (
            <>
      ...
      {/* Rechterkolom: Podcast en E-learning tegels, zelfstandig uitgelijnd ernaast */}
      <div className="lg:col-span-5 xl:col-span-4 flex flex-col justify-between gap-3.5">
        {/* Tegel 1: Podcast ECHO */}
        <a
          href="https://echo-net.nl/stagediscriminatie-onder-de-loep/"
          target="_blank"
          rel="noopener noreferrer"
          className="p-4 bg-white border border-[#EDE6DA] hover:border-[#D3104C] rounded-2xl text-[#003340] hover:bg-[#FFF8FA] transition-all shadow-none group flex-1 flex flex-col justify-between"
          title="Beluister de ECHO-podcastserie: Stagediscriminatie onder de loep"
        >
          <div>
            <div className="flex items-center justify-between gap-1 mb-2">
              <span className="text-[10px] font-bold uppercase tracking-wider text-[#D3104C] bg-[#FDEEF3] px-2.5 py-0.5 rounded-full border border-[#F9D0DD]">
                Podcast &middot; ECHO
              </span>
              <span className="text-xs font-bold text-[#D3104C] group-hover:translate-x-0.5 transition-transform flex items-center gap-0.5">
                Luister
                <ExternalLink className="w-3 h-3" />
              </span>
            </div>
            <div className="flex items-start gap-2.5 mb-1.5">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#D3104C] to-[#8C002B] text-white flex items-center justify-center shrink-0 shadow-none">
                <Mic className="w-4 h-4 group-hover:scale-110 transition-transform" />
              </div>
              <h3 className="text-xs md:text-sm font-bold text-[#003340] leading-snug group-hover:text-[#D3104C] transition-colors">
                Stagediscriminatie onder de loep
              </h3>
            </div>
            <p className="text-xs text-[#5A5A55] leading-relaxed pl-0.5">
              5-delige audioserie over studentervaringen, meldingsdrempels en praktische handelingsperspectieven.
            </p>
          </div>
        </a>

        {/* Tegel 2: E-learning Anne Frank Stichting */}
        <a
          href="https://www.annefrank.org/nl/elearning/module/begeleider-van-stagiairs/"
          target="_blank"
          rel="noopener noreferrer"
          className="p-4 bg-white border border-[#EDE6DA] hover:border-[#217772] rounded-2xl text-[#003340] hover:bg-[#F2FAF9] transition-all shadow-none group flex-1 flex flex-col justify-between"
          title="Start de gratis e-learning van de Anne Frank Stichting"
        >
          <div>
            <div className="flex items-center justify-between gap-1 mb-2">
              <span className="text-[10px] font-bold uppercase tracking-wider text-[#217772] bg-[#EDFAF9] px-2.5 py-0.5 rounded-full border border-[#C5EDE9]">
                E-learning &middot; Anne Frank
              </span>
              <span className="text-xs font-bold text-[#217772] group-hover:translate-x-0.5 transition-transform flex items-center gap-0.5">
                Starten
                <ExternalLink className="w-3 h-3" />
              </span>
            </div>
            <div className="flex items-start gap-2.5 mb-1.5">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#217772] to-[#003340] text-white flex items-center justify-center shrink-0 shadow-none">
                <Headphones className="w-4 h-4 group-hover:scale-110 transition-transform" />
              </div>
              <h3 className="text-xs md:text-sm font-bold text-[#003340] leading-snug group-hover:text-[#217772] transition-colors">
